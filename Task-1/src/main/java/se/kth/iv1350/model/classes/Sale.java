...
public class Sale {
  ...
  private void notifyObservers() {
    for (TotalRevenueTemplate observer : saleObservers) {
      observer.newSaleWasMade(getTotalPrice());
    }
  }
   ...
   */
  public void addSaleObservers(ArrayList<TotalRevenueTemplate> observers) {
