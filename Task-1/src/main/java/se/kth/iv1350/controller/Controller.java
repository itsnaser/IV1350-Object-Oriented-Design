...
public class Controller {
  ...
  private Sale sale;
  private ArrayList<TotalRevenueTemplate> saleObservers = new ArrayList<TotalRevenueTemplate>();
   ...
   *
   * @param observer The {@link TotalRevenueTemplate} to add.
   */
  public void addSaleObserver(TotalRevenueTemplate observer) {
   ...
   *
   * @param observers The list of {@link TotalRevenueTemplate} to add.
   */
  public void addSaleObservers(List<TotalRevenueTemplate> observers) {
